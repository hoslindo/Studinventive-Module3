...
function goToQuizz(event) {
    ...
    session.localStorage.setItem("numeroDeQuizz",numeroDeQuizz);
    ...
    session.localStorage.setItem("suiviQuizzNum"+String(numeroDeQuizz),JSON.stringify(Array(questions[numeroDeQuizz].length).fill(false)));
