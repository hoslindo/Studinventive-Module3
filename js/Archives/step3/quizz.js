...
function afficherQuizzTermine() {
  ...
  const suivi=JSON.parse(session.localStorage.getItem("suivi"+prenom));
...
function validationDuQuizz (event) { DEBUG("début traitement du clic");
  ...
  session.localStorage.setItem("suiviQuizzNum"+numeroDeQuizz,JSON.stringify(suivi));
...
const numeroDeQuizz = JSON.parse(session.localStorage.getItem("numeroDeQuizz"));
...
const reponses = JSON.parse(session.localStorage.getItem("reponses"));
const prenom = session.localStorage.getItem("identiteDuCandidat");
...
const suivi= JSON.parse(session.localStorage.getItem("suiviQuizzNum"+String(numeroDeQuizz)));
/*----------------------------------------------------------------------------------------------------------*/
